...
public class ContactServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("contact")) {
            ...
            } else if (action.equalsIgnoreCase("contactStaff")) {
                ...
                ArrayList<Table> tables = TableModel.getTablesByDateTime(date, time);
                ...
                String[] tableIDs = information.split(" ");
                Account account = (Account) session.getAttribute("account");
                String email = account.getEmail();
                
                //Will update payment method
                TableModel.BookingTable(email, date, time, tableIDs);
                request.getRequestDispatcher("index.jsp").forward(request, response);
            }
        } catch (Exception ex) {
